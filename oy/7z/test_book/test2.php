...
<form name="form1" method="post">
     <table width="587" border="1" cellpadding="1" cellspacing="1" bordercolor="#66CC33" bgcolor="#FFFFFF">
       <tr>
         ...
         <td width="479" height="30" bgcolor="#CCFF33">&nbsp;           <input name="图书名称2" type="text" class="inputcss" id="图书名称" size="24">
         作者：           <input name="作者2" type="text" class="inputcss" id="作者" size="16">
         &nbsp;
